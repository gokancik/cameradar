...
const (
	defaultCredentialDictionaryPath = "${GOPATH}/src/github.com/gokancik/cameradar/dictionaries/credentials.json"
	defaultRouteDictionaryPath      = "${GOPATH}/src/github.com/gokancik/cameradar/dictionaries/routes"
)
