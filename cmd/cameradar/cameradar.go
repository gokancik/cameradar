...
import (
	...
	"github.com/gokancik/cameradar/v5"
...
func parseArguments() error {
	...
	pflag.StringP("custom-routes", "r", "${GOPATH}/home/kali/Desktop/cameradar/dictionaries/routes", "The path on which to load a custom routes dictionary")
	pflag.StringP("custom-credentials", "c", "${GOPATH}/home/kali/Desktop/cameradar/dictionaries/credentials.json", "The path on which to load a custom credentials JSON dictionary")
