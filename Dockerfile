...
# Fix for https://github.com/gokancik/cameradar/issues/247
...
COPY --from=build-env ./dictionaries/ /app/dictionaries/
COPY --from=build-env ./ /app/cameradar/
